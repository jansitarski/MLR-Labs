...
class simple_perceptron:
    ...
    def train(self, Xtrain, Ytrain, Xvalid, Yvalid):
        ...
        for epoch in range(self.epochs):
            ...
            for i in range(len(Xtrain)):
                ...
                for j in range(self.Nin):
                    ...
                    # ZADANIE - uzupełnić prawą stronę wzoru na zmianę wagi
        ...
        print('Training completed in {} seconds.'.format(round(timer() - start_time, 2)))
    ...
    def save_model(self, filename):
        ...
        nope / self.min_val    float
        nope / self.max_val    float
        '''
        data = {
            "N": self.Nin,
        ...
        yaml.dump(data, file)
        #file.write(str(self.Nin)+"\n")
        #file.write(self.activation+"\n")
        #np.savetxt(file, self.weights)
        file.close()
        # ZADANIE - opracować i zaimplementować jakiś sposób na zapis parametrów modelu do pliku
    ...
    #self.Nin = file.readline()
        #self.activation = file.readline()
        ##for weight in file.read():
        ##    self.weights += weight
        #self.weights = np.loadtxt(file.readline())
    # ZADANIE - zaimplementować odczyt parametrów modelu z pliku

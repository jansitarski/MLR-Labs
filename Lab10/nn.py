...
class LeNet5:
    ...
    def build(width, height, depth, classes):
        ...
        model = tf.keras.models.Sequential()
        inputShape = (height, width, depth)
        # C1 Convolutional Layer. Padding='same' gives the same output as input, 
        # so the input images could be treated as 32x32 px
